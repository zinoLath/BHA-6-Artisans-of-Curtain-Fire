...
LoadImageFromFile("low_perf_bg", path.."low_perf_bg.png")
...
function mistylake_bg:render()
    if not setting.lowperf then
        ...
        local x,y = -lstg.worldoffset.centerx*0.5,-lstg.worldoffset.centery*0.5
        RenderRect("low_perf_bg",lstg.world.l+x,lstg.world.r+x,lstg.world.b+y,lstg.world.t+y)
    end
